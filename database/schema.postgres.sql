...
INSERT INTO permissoes_acesso (perfil_id, menu_id, pode_ler, pode_criar, pode_editar, pode_deletar)
SELECT 2, id, TRUE,
       CASE WHEN rota IN ('/pacientes','/medicos','/remedios','/consultas','/agenda','/timeline','/rotina')
              OR titulo IN ('Saúde','Atividades','Dashboard') THEN TRUE ELSE FALSE END,
       CASE WHEN rota IN ('/pacientes','/medicos','/remedios','/consultas','/rotina') THEN TRUE ELSE FALSE END,
       FALSE
...
INSERT INTO permissoes_acesso (perfil_id, menu_id, pode_ler, pode_criar, pode_editar, pode_deletar)
SELECT 4, id, TRUE,
       CASE WHEN rota IN ('/rotina','/agenda','/timeline') THEN TRUE ELSE FALSE END,
       CASE WHEN rota IN ('/rotina') THEN TRUE ELSE FALSE END,
       FALSE
